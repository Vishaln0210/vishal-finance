    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setShowModal(true)}
          className="flex items-center gap-2 bg-[#1A1F3A] text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-[#2D4A8A] transition">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4">
        <KpiCard label="Total Current Balance" value={fmt(totalCurrentBalance)} color="bg-emerald-50" icon={<Wallet className="w-4 h-4 text-emerald-600" />} />
        ...
        <KpiCard label="Still Owed to You" value={fmt(stillOwed)} color="bg-red-50" sub="Go to Money Lent →" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white rounded-xl p-5 shadow-sm border border-black/5">
          <h3 className="text-sm font-semibold text-gray-700 mb-4">Income vs Expenses by Month</h3>
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm border border-black/5">
        <h3 className="text-sm font-semibold text-gray-700 mb-4">Net Savings Trend</h3>
            ...
            <div key={t.id} className="flex items-center justify-between px-5 py-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">{t.category} · {t.account} · {t.date}</p>
                </div>
              </div>
